  ...
  return (
    ...
    >
      <div className="relative h-full w-full overflow-hidden">
        ...
        >
          <div className="flex h-full min-h-0 flex-col overflow-hidden rounded-xl border border-white/20 bg-[radial-gradient(circle_at_18%_0%,rgba(245,158,11,0.10),transparent_34%),linear-gradient(145deg,rgba(25,28,34,0.98),rgba(12,14,18,0.98))] shadow-[0_0_0_1px_rgba(255,255,255,0.05),0_24px_60px_rgba(0,0,0,0.65)] backdrop-blur">
