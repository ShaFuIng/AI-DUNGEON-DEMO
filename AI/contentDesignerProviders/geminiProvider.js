function buildPrompt(input = {}) {
  ...
  return [
    ...
    '- item 可以包含 command；若沒有 command，前端會自動使用 use <item.id>。',
    '- consumable item 可以包含 effect，例如 { "hp": 10 }。',
    '- consumable item 必須有 effect。',
    '- key item 必須包含 unlocks，例如 ["boss_room"]，可填 roomId / gateId / eventId。',
    '- key item 的 usageHint 必須描述能在哪裡使用。',
    '- quest item 的 usageHint 必須描述任務目標。',
